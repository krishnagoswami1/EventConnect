...
class EventSearch:
    def __init__(self):
        ...
        self.client = QdrantClient(url = "https://4341ac7b-ffd3-4a57-8408-cf157cdfb9eb.europe-west3-0.gcp.cloud.qdrant.io:6333", api_key =  "YbdHNsLyChGrPeq-XJzjVOmOHfMb8gj1E7OpTJeEhBolZhl3XMbnAA")
